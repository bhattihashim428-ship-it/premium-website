  ...
  theme: {
    extend: {
      backgroundImage: {
        ...
        'gold-gradient': 'linear-gradient(135deg, #D4AF37 0%, #F4D77A 50%, #D4AF37 100%)',
        'gold-shine': 'linear-gradient(120deg, transparent 30%, rgba(244,215,122,0.4) 50%, transparent 70%)',
      },
      borderRadius: {
        lg: 'var(--radius)',
